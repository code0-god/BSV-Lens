...
for (const entry of [
    ...
    'extension/src/architecture/semantic/behavior-bindings.js',
    'extension/src/architecture/semantic/boundaries.js',
    'extension/src/architecture/semantic/constructor-bindings.js',
    'extension/src/architecture/semantic/contracts.js',
    'extension/src/architecture/semantic/definitions.js',
    'extension/src/architecture/semantic/endpoints.js',
    'extension/src/architecture/semantic/ids.js',
    'extension/src/architecture/semantic/indexes.js',
    'extension/src/architecture/semantic/instances.js',
    'extension/src/architecture/semantic/model.js',
    'extension/src/architecture/semantic/projection.js',
    'extension/src/architecture/semantic/protocol-channels.js',
    'extension/src/architecture/semantic/provenance.js',
    'extension/src/architecture/semantic/scheduling.js',
    'extension/src/architecture/semantic/semantic-flow.js',
    'extension/src/architecture/semantic/source-references.js',
    'extension/src/architecture/semantic/state-behaviors.js',
...
for (const entry of [
    ...
    `${prefix}test/fixtures/semantic-workspace/.bsv-arch.json`,
    `${prefix}test/fixtures/semantic-workspace/src/SemanticFlowFixture.bsv`,
    `${prefix}test/semantic-projection.test.js`,
    `${prefix}test/aqua-semantic-schedulers.acceptance.js`,
