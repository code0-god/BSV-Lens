#!/usr/bin/env python3
"""Explicit author-only run02 stages. No acquisition, host install or automatic retry."""
import argparse
import datetime
import re
import hashlib
...
def main():
    ...
    name = "g3-origin-st_01a07a97-run02"
    ...
    argv = ["docker","create","--name",name,"--pull=never","--platform","linux/arm64",
            ...
            "--env","HOME=/opt/g3-home","--env","CABAL_DIR=/opt/g3-cabal",
            "--env","GHC=ghc -XFlexibleContexts",
            "--env","GIT_CONFIG_COUNT=1","--env","GIT_CONFIG_KEY_0=safe.directory",
            "--env","GIT_CONFIG_VALUE_0=/work/bsc","--workdir","/work/bsc",
            "--label","g3.task=st_01a07a97","--label","g3.run=run02",
